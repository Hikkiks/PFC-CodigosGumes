...
BancoD=fullfile(pastascripts,'DadosSalvos','DadosFab','DadosFab1.mat');
...
%% Calcular perda de Epstein-Peterson
...
disp(['Perda Epstein-Peterson : ',num2str(pathlossepstein),' dB'])
